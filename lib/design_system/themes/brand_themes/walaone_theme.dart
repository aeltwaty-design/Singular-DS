...
/// WALAONE BRAND THEME
/// =============================================================================
/// Brand configuration for WalaOne product.
/// Primary: #755BD8 (Royal Purple)
/// Secondary: #FAC333 (Golden Yellow)
/// =============================================================================

/// WalaOne brand theme configuration
class WalaOneTheme {
  WalaOneTheme._();

  /// Brand identifier
  static const String brandName = 'WalaOne';

  /// Primary color swatch
  static Map<int, Color> get primarySwatch => WalaOnePrimary.swatch;

  /// Secondary color swatch
  static Map<int, Color> get secondarySwatch => WalaOneSecondary.swatch;

  /// Primary brand color
  static Color get primaryColor => WalaOnePrimary.shade500;

  /// Secondary brand color
  static Color get secondaryColor => WalaOneSecondary.shade500;
