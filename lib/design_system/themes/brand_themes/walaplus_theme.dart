...
/// =============================================================================
/// WALAPLUS BRAND THEME
/// =============================================================================
/// Brand configuration for WalaPlus product.
/// Primary: #00CE8B (Vibrant Green)
/// Secondary: #FF6608 (Vibrant Orange)
/// =============================================================================

/// WalaPlus brand theme configuration
class WalaPlusTheme {
  WalaPlusTheme._();

  /// Brand identifier
  static const String brandName = 'WalaPlus';

  /// Primary color swatch
  static Map<int, Color> get primarySwatch => WalaPlusPrimary.swatch;

  /// Secondary color swatch
  static Map<int, Color> get secondarySwatch => WalaPlusSecondary.swatch;

  /// Primary brand color
  static Color get primaryColor => WalaPlusPrimary.shade500;

  /// Secondary brand color
  static Color get secondaryColor => WalaPlusSecondary.shade500;
