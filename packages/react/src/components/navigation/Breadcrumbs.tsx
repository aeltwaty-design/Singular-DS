...
const tokens = {
  colors: {
    textCurrent: 'text-neutral-900 dark:text-white',
    textDefault: 'text-neutral-500 dark:text-neutral-400',
    textHover: 'text-neutral-700 dark:text-neutral-300',
  ...
  typography: {
    base: 'text-base font-medium leading-[1.5]',
  },
  focus: {
