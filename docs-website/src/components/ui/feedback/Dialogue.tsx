...
// Import Button atom for composition compliance
...
export interface DialogueProps {
  /** Type of dialogue - icon shows status icons, media shows images */
  type?: DialogueType;
  /** Status determines the icon and confirm button style */
  status?: DialogueStatus;
  /** Alignment of content - centered or stacked (left-aligned) */
  alignment?: DialogueAlignment;
  /** Breakpoint for responsive sizing */
  ...
  onCancel?: () => void;
  /** Callback when dialogue is closed (overlay click or escape) */
  onClose?: () => void;
  /** Show dark overlay behind dialogue */
  showOverlay?: boolean;
...
// ============================================================================
// Status Illustration Component (using Iconsax styled as illustrations)
// ============================================================================
...
export function Dialogue({
  ...
  // Media dimensions based on breakpoint
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <DialogueContent breakpoint={breakpoint} className={cn('pointer-events-auto', className)}>
          <div className="p-6 flex flex-col gap-8">
            ...
            {/* Actions (Dock) - Using Button atoms for composition compliance */}
...
// ============================================================================
// Inline Dialogue (No Overlay - for documentation demos)
// ============================================================================
