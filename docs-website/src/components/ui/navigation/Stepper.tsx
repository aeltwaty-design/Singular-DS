...
const tokens = {
  ...
  colors: {
    ...
    connector: {
      completed: '', // Uses brand color (applied via style)
  ...
  spacing: {
    horizontal: {
      content: 'mt-2', // Gap between indicator and content
      contentGap: 'gap-0.5', // Gap between title and description
    },
    vertical: {
      content: 'ms-3', // Gap between indicator and content (supports RTL)
      contentGap: 'gap-0.5', // Gap between title and description
      step: 'gap-3', // Gap within each step
    },
  },
