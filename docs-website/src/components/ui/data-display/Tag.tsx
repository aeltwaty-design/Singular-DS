 ...
 * Tag Component
 * 
 * A versatile tag/chip component for categorization, filtering, and status display.
 * Based on Figma design specifications from Singular Design System.
 * 
 * Variants from Figma:
 * - Type: primary (solid), secondary (light/subtle)
 * - Size: sm (22px height), md (25px height), lg (32px height)
 * - Status: default (brand), gray, danger, warning, success, info, disabled
 * - Optional leading/trailing icons
 * - Optional removable (with close button)
 */
...
export interface TagProps
  ...
  children: ReactNode;
  /** Tag type - primary (solid) or secondary (subtle/light) */
  type?: TagType;
  ...
  /** Whether the tag can be removed (shows close button) */
  removable?: boolean;
