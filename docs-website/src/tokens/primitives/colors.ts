/**
 * Color Primitives
 * Raw color values - the foundation of the color system
 */
...
/**
 * Gray palette optimized for light mode
 */
...
/**
 * Gray palette optimized for dark mode
 */
...
/**
 * Alpha values for opacity scales (hex suffix)
 */
...
/**
 * Generate alpha color from base color
 */
